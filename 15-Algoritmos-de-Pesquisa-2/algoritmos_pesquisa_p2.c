...
int main(){
	int vetor[]={12,25,27,33,37,48,53,57,86,92};
	printf("Result. Busca Binaria.Indice: %d\n",busca_binaria(8,vetor,10));
	printf("Result. Busca intepolacao.indice: %d\n", busca_interpolacao(57,vetor,10));
    return 0;
}
